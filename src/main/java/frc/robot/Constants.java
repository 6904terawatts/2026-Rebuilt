...
public final class Constants {
  ...
  // Simple replacement for YAGSL Matter class - just stores position and mass
  public static class SimpleMatter {
    public final Translation3d position;
    public final double mass;
    public SimpleMatter(Translation3d position, double mass) {
      this.position = position;
      this.mass = mass;
    }
  }
  public static final SimpleMatter CHASSIS = new SimpleMatter(new Translation3d(0, 0, Units.inchesToMeters(8)), ROBOT_MASS);
  ...
  // OLD YAGSL DriveConstants - IGNORED (CTRE swerve uses TunerConstants.java)
  // Keeping for reference but these motor IDs are no longer used
  /*
  ...
  */
  ...
  public static class IntakeConstants {
    ...
    public static final int kPivotMotorId = 32;
