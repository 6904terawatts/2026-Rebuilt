...
public class TurretSubsystem extends SubsystemBase {
  ...
  private SparkFlex spark = new SparkFlex(Constants.TurretConstants.kMotorId, MotorType.kBrushless);
  ...
  private SmartMotorController smc = new SparkWrapper(spark, DCMotor.getNeoVortex(1), smcConfig);
